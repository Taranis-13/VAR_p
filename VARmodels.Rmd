...
Ce sont ces valeurs propres qui seront soumises aux tests statistiques.  
Dans la littérature traitant de ces tests on lit souvent l'expression "racines unitaires" ("units roots"), de quoi s'agit-t-il?  
...
Les conclusions sont irrévocables, en plus on remarque une bonne estimation des coefficients. N'oublions pas que z.lag.1 donne 1-0.7 .
tau3 les valeurs critiques concernant rho, phi2 et phi3 le trend et la constante.  

Voyons le modèle 2 sans trend. Mais volontairement testons un modèle de type 1 sans trend.
