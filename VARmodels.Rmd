...
\end{array}\right.$$
Il est clair que chaque composante est stationnaire, comme le montre le graphique ci-dssous.
...
En effet la matrice des covariances est:  $$\Gamma_{h,t}=\left[\begin{array}{c} 1 & (-1)^{t}\\(-1)^{t} & 2\end{array}\right]$$
qui dépend de t .
